...
//        int keepAlive = 1;
//        status = setsockopt(socketFD, SOL_SOCKET, SO_KEEPALIVE, &keepAlive, sizeof(keepAlive));
//        if (status == -1) {
//            NSString *reason = @"Error create socket keepAlive failed";
//            err = [self errnoErrorWithReason:reason];
//            
//            close(socketFD);
//            return  SOCKET_NULL;
...
//        
//        int delay = 120;
//        status = setsockopt(socketFD, IPPROTO_TCP, TCP_KEEPALIVE, &delay, sizeof(delay));
//        if (status == -1) {
//            NSString *reason = @"Error create tcp keepAlive delay 120 failed";
//            err = [self errnoErrorWithReason:reason];
//            
//            close(socketFD);
//            return  SOCKET_NULL;
